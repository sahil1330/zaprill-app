...
import { MapPin, Building2, ExternalLink, Wifi, Clock, DollarSign } from 'lucide-react'
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start', marginBottom: 14 }}>
        ...
        <div style={{
          ...
          color: rank === 0 ? '#fff' : rank <= 2 ? '#a5b4fc' : 'var(--text-muted)',
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'var(--text-secondary)', fontSize: '13px', flexWrap: 'wrap' }}>
            <Building2 size={12} />
            ...
            {job.isRemote && (
              <>
                <span style={{ color: 'var(--text-muted)' }}>·</span>
                <span className="badge badge-success" style={{ padding: '2px 6px', fontSize: '11px', display: 'inline-flex', alignItems: 'center', gap: 3 }}>
                  <Wifi size={9} /> Remote
                </span>
              </>
            )}
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 14, flexWrap: 'wrap' }}>
        {job.salary && (
          <span style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: '12px', color: '#34d399' }}>
        ...
        {postedText && (
          <span style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: '12px', color: 'var(--text-muted)', marginLeft: 'auto' }}>
      ...
      <div style={{ marginBottom: 14 }}>
        {showMatched.length > 0 && (
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 6 }}>
            <span style={{ fontSize: '11px', color: 'var(--text-muted)', alignSelf: 'center', flexShrink: 0 }}>✅</span>
            {showMatched.map((s) => (
